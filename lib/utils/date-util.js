...
export const getHalfYearByMonth = function (date) {
  const month = date.getMonth() + 1;
  return month < 6 ? 0 : 1;
};

export const getMonthByHalfYear = function (halfYear) {
  return halfYear * 6;
};

export const getQuarterByMonth = function (date) {
  const month = date.getMonth() + 1;
  return Math.floor((month - 1) / 3);
};

export const getMonthByQuarter = function (quarter) {
  return (quarter + 1) * 3 - 3;
};

export const getTendayByDay = function (date) {
  const day = date.getDate();
  return Math.floor(day / 10);
};

export const getDayByTenday = function (tenday) {
  return tenday * 10 + 1;
};
